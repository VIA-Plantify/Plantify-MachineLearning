...
class PlantDataGenerator:
    ...
    @staticmethod
    def export_plants_csv(plants: List[Plant], filename: str = "plants_users.csv"):
    ...
    @staticmethod
    def export_sensor_datas_csv(plants: List[Plant], filename: str = "sensor_datas_users.csv"):
    ...
    @staticmethod
    def export_waterings_csv(plants: List[Plant], filename: str = "waterings_users.csv"):
